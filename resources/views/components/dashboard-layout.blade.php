    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar-ios fixed inset-y-0 left-0 w-56 z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-200" id="sidebar">
            ...
            <nav class="p-3 space-y-1">
                ...
                <a href="{{ route('transaksi.index') }}" class="list-item-ios {{ request()->routeIs('transaksi.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('kategori.index') }}" class="list-item-ios {{ request()->routeIs('kategori.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('budget.index') }}" class="list-item-ios {{ request()->routeIs('budget.*') ? 'active' : '' }}">
